...
(HINT: you can read that value with the .value property in Javascript. This is a good oportunity to use google to figure
    this out :)
3. Add another dice to the game, so that there are two dices now. The player looses his current score
whent one of them is a 1. (HINT: you will need CSS to position the second dice, do take a look at the CSS code for the first one.)
*/